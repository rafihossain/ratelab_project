...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <h4 class="d-flex">Email Authentication</h4>
            ...
            <div class="col-lg-12 col-md-12 mb-30">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url() ?>/admin/frontend/email_authentication" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="old_image" value="<?php echo $email_authentication[2]['settings_value'];?>">
                            <div class="row">

                                   <div class="form-group mb-2 ml-1">
                                        <label class="form-control-label font-weight-bold"><b>Heading</b></label>

                                        <input type="text" class="form-control" name="heading" value="<?php echo $email_authentication[0]['settings_value'];?>">
                                    </div><br>

                                    <div class="form-group ml-1">
                                        <label class="form-control-label  font-weight-bold"><b>Subheading</b></label>
                                        <input type="text" name="sub_heading" class="form-control" value="<?php echo $email_authentication[1]['settings_value'];?>">
                                    </div>
                                <div class="col-xl-4">
                                        ...
                                        <div class="image-upload">
                                            <div class="thumb">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview" style="background-image: url(<?= base_url() ?>/admin/uploads/email_authentication/<?php echo $email_authentication[2]['settings_value'];?>)">
