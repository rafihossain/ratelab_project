...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <h4 class="d-flex">Forgot Password Page</h4>
            ...
            <div class="col-lg-12 col-md-12 mb-30">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url() ?>/admin/frontend/forgot_password_page" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="old_image" value="<?php echo $forgot_password[2]['settings_value'];?>">
                            <div class="row">

                                   <div class="form-group mb-2 ml-1">
                                        <label class="form-control-label font-weight-bold"><b>Heading</b></label>

                                        <input type="text" class="form-control" name="heading" value="<?php echo $forgot_password[0]['settings_value'];?>">
                                    </div><br>

                                    <div class="form-group ml-1">
                                        <label class="form-control-label  font-weight-bold"><b>Subheading</b></label>
                                        <input type="text" name="sub_heading" class="form-control" value="<?php echo $forgot_password[1]['settings_value'];?>">
                                    </div>
                                <div class="col-xl-4">
                                        ...
                                        <div class="image-upload">
                                            <div class="thumb">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview" style="background-image: url(<?= base_url() ?>/admin/uploads/forget_password/<?php echo $forgot_password[2]['settings_value'];?>)">
                                                ...
                                                <div class="avatar-edit">
                                                    ...
                                                    <small class="mt-2 text-facebook">Supported files: <b>jpeg, jpg, png</b>. Image will be resized into  830x620 px.</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
