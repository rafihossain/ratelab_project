    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 mb-30">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url() ?>/admin/frontend/register" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="old_image" value="<?php echo $register_section[2]['settings_value'];?>">
                            <div class="row">

                                   <div class="form-group mb-2 ml-1">
                                        <label class="form-control-label font-weight-bold"><b>Greeting</b></label>

                                        <input type="text" class="form-control" name="greeting" value="<?php echo $register_section[0]['settings_value'];?>">
                                    </div><br>

                                    <div class="form-group ml-1">
                                        <label class="form-control-label  font-weight-bold"><b>Heading</b></label>
                                        <input type="text" name="heading" class="form-control" value="<?php echo $register_section[1]['settings_value'];?>">
                                    </div>
                                <div class="col-xl-4">
                                        ...
                                        <div class="image-upload">
                                            <div class="thumb">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview" style="background-image: url(<?= base_url() ?>/admin/uploads/register/<?php echo $register_section[2]['settings_value'];?>)">
