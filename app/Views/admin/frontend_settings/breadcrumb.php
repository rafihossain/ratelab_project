    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 mb-30">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url() ?>/admin/frontend/breadcrumb" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="old_image" value="<?= $breadcrumb[0]['settings_value'];?>">
                            <div class="row">
                                        ...
                                        <div class="image-upload">
                                            <div class="thumb">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview" style="background-image: url(<?= base_url() ?>/admin/uploads/breadcrumb/<?php echo $breadcrumb[0]['settings_value'];?>)">
