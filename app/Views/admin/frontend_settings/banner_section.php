...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <h4 class="d-flex">Banner Section</h4>
            ...
            <div class="col-lg-12 col-md-12 mb-30">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url() ?>/admin/frontend/banner_section" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="old_image" value="<?= $frontend_manager[2]['settings_value'];?>">
                                        ...
                                        <div class="image-upload">
                                            <div class="thumb">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview" style="background-image: url(<?= base_url() ?>/admin/uploads/banner_section/<?= $frontend_manager[2]['settings_value'];?>)">
