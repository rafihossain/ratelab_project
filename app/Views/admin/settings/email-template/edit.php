    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <div class="d-flex">
                ...
                <a href="<?= base_url() ?>/admin/settings/email_template/index" class="btn btn-primary ms-auto">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <form id="identifier" action="<?= base_url() ?>/admin/settings/email_template/edit/<?= $editTemps->id; ?>" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="mb-4">
                                                <label for="">Subject <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="mail_subject" value="<?= $editTemps->mail_subject; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-4">
                                                ...
                                                <input type="checkbox" name="mail_status" <?= ($editTemps->mail_status == 1 ? 'checked' : ''); ?> value="1">
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="mail_body" style="display:none" id="hiddenArea"></textarea>
