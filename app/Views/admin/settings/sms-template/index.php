...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <h4 class="d-flex">SMS Templates</h4>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="extension" class="table" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php foreach($smsTemps as $temps) : ?>
                                                <tr>
                                                    <td><?= $temps->name; ?></td>
                                                    <td>
                                                        <?php if ($temps->sms_status == 1) { ?>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url() ?>/admin/settings/sms_template/edit/<?= $temps->id; ?>" class="btn btn-primary btn-sm" title="Edit">
