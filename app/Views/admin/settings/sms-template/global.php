            ...
            <div class="col-lg-12 col-md-12 mb-30">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card mt-4">
                            <div class="card-body">
                                <form id="identifier" action="<?= base_url() ?>/admin/settings/sms_template/global" method="post" enctype="multipart/form-data">
                                    <div class="mb-4">
                                        <label class="mb-1" for="">Global Template <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="global_template" value="<?= $smsTempGlobal->settings_value; ?>">
                                    </div>
