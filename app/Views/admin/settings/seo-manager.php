    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 mb-30">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url() ?>/admin/settings/seo_manager" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                        ...
                                        <div class="image-upload">
                                            <div class="thumb">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview" style="background-image: url(<?= base_url() ?>/admin/uploads/<?= $seomanager[4]; ?>)">
                                                        <button type="button" class="remove-image"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </div>
                                                <div class="avatar-edit">
                                                    <input type="hidden" name="old_image" value="<?= $seomanager[4]; ?>">
                                                    <input type="file" class="profilePicUpload" name="image" id="profilePicUpload1" accept=".png, .jpg, .jpeg">
                                                    <label for="profilePicUpload1" class="select-logo">Upload Image</label>
                                                    <small class="mt-2 text-facebook">Supported files: <b>jpeg, jpg</b>. Image will be resized into 600x315px. </small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-8 mt-xl-0 mt-4">
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control keywords-multiple" name="meta_keywords[]" multiple="multiple">
                                            
                                            <?php
                                            $explods = explode(',', $seomanager[0]);
                                            foreach($explods as $seo) : ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="meta_description" rows="3" class="form-control" placeholder="SEO meta description" required=""><?= $seomanager[1]; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label  font-weight-bold">Social Title</label>
                                        <input type="text" class="form-control" placeholder="Social Share Title" name="social_title" value="<?= $seomanager[2]; ?>" required="">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-control-label  font-weight-bold">Social Description</label>
                                        <textarea name="social_description" rows="3" class="form-control" placeholder="Social Share  meta description" required=""><?= $seomanager[3]; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary w-100 mt-4 btn-lg">Update</button>
                                    </div>
                                </div>
...
<script src="<?= base_url() ?>/admin/assets/select2/select2.min.js"></script>
