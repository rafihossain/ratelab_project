...
<head>
    ...
    <!-- Datatables -->
    <link href="<?= base_url() ?>/admin/assets/libs/datatables.net-bs5/css/dataTables.bootstrap5.min.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url() ?>/admin/assets/libs/datatables.net-responsive-bs5/css/responsive.bootstrap5.min.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url() ?>/admin/assets/libs/datatables.net-buttons-bs5/css/buttons.bootstrap5.min.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url() ?>/admin/assets/libs/datatables.net-select-bs5/css//select.bootstrap5.min.css" rel="stylesheet" type="text/css" />
    <link href="https://gitcdn.github.io/bootstrap-toggle/2.2.2/css/bootstrap-toggle.min.css" rel="stylesheet">
    
    <!--Font Awesome css-->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"   />
    <link href="<?= base_url() ?>/admin/assets/css/fontawesome-iconpicker.min.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/admin/assets/summernote/summernote-bs4.min.css">
        ...
        <div class="navbar-custom">
            <ul class="list-unstyled topnav-menu float-end mb-0">
                        ...
                        <div class="noti-scroll" data-simplebar>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                <div class="notify-icon">
                                    <img src="<?= base_url() ?>/admin/assets/images/users/user-1.jpg" class="img-fluid rounded-circle" alt="" />
                                </div>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="notify-icon">
                                    <img src="<?= base_url() ?>/admin/assets/images/users/user-4.jpg" class="img-fluid rounded-circle" alt="" />
                                </div>
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        <img src="<?= base_url() ?>/admin/assets/images/users/user-1.jpg" alt="user-image" class="rounded-circle">
            ...
            <div class="logo-box">
                <a href="<?= base_url(); ?>/home" class="logo logo-light text-center">
                    <span class="logo-sm">
                        <img src="<?= base_url() ?>/admin/assets/images/logo-sm.png" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?= base_url() ?>/admin/assets/images/logo-light.png" alt="" height="16">
                    </span>
                </a>
