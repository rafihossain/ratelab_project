    ...
    <div class="content">
        ...
        <h4 class="d-flex">Blog Section Items<a href="<?= base_url() ?>/admin/frontend/blog_section" type="button" class="ms-auto btn btn-primary" style="background-color:#7367f0">
            ...
            <div class="col-lg-12 col-md-12 mb-30">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url() ?>/admin/frontend/blog/update/<?php echo $edit_data['id'];?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                        ...
                                        <div class="image-upload">
                                            <div class="thumb">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview" style="background-image: url(<?= base_url() ?>/admin/uploads/blog_section/<?php echo $edit_data['image'];?>)">
                                ...
                                <div class="col-xl-8 mt-xl-0 mt-4">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="title" placeholder="title" value="<?php echo $edit_data['title'];?>">
                                        <small style="color:red;" class="text-danger">
                                            <?php if (isset($validation)) {
